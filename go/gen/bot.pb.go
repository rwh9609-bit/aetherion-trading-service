...
const file_protos_bot_proto_rawDesc = "" +
	"\n" +
	"\x10protos/bot.proto\x12\atrading\x1a\x11trading_api.proto\"\xb7\x02\n" +
	"\tBotConfig\x12\x15\n" +
	...
	"\aBotList\x12&\n" +
	"\x04bots\x18\x01 \x03(\v2\x12.trading.BotConfigR\x04bots2\xb7\x02\n" +
	"\n" +
	"BotService\x12A\n" +
...
var file_protos_bot_proto_goTypes = []any{
	...
	(*BotList)(nil),          // 3: trading.BotList
	nil,                      // 4: trading.BotConfig.ParametersEntry
	nil,                      // 5: trading.CreateBotRequest.ParametersEntry
...
var file_protos_bot_proto_depIdxs = []int32{
	...
	1, // 3: trading.BotService.CreateBot:input_type -> trading.CreateBotRequest
	...
	3, // 9: trading.BotService.ListBots:output_type -> trading.BotList
	...
	0, // 12: trading.BotService.GetBotStatus:output_type -> trading.BotConfig
