 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.aetherion.RefreshTokenRequest,
 *   !proto.aetherion.AuthResponse>}
 */
const methodDescriptor_AuthService_RefreshToken = new grpc.web.MethodDescriptor(
  ...
  proto.aetherion.AuthResponse,
  /**
   * @param {!proto.aetherion.RefreshTokenRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.aetherion.RefreshTokenRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.aetherion.AuthResponse)}
 ...
 *     The XHR Node Readable Stream
 */
proto.aetherion.AuthServiceClient.prototype.refreshToken =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/aetherion.AuthService/RefreshToken',
      request,
 ...
 *     Promise that resolves to the response
 */
proto.aetherion.AuthServicePromiseClient.prototype.refreshToken =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/aetherion.AuthService/RefreshToken',
      request,
...
/**
 * @param {!proto.aetherion.BotIdRequest} request The request proto
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!grpc.web.ClientReadableStream<!proto.aetherion.Bot>}
 *     The XHR Node Readable Stream
 */
proto.aetherion.BotServiceClient.prototype.streamBotStatus =
    function(request, metadata) {
 ...
 *     The XHR Node Readable Stream
 */
proto.aetherion.BotServicePromiseClient.prototype.streamBotStatus =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/aetherion.BotService/StreamBotStatus',
      request,
...
/**
 * @param {!proto.aetherion.PortfolioRequest} request The request proto
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!grpc.web.ClientReadableStream<!proto.aetherion.PortfolioResponse>}
 *     The XHR Node Readable Stream
 */
proto.aetherion.PortfolioServiceClient.prototype.streamPortfolio =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/aetherion.PortfolioService/StreamPortfolio',
      request,
 ...
 *     The XHR Node Readable Stream
 */
proto.aetherion.PortfolioServicePromiseClient.prototype.streamPortfolio =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/aetherion.PortfolioService/StreamPortfolio',
      request,
 ...
 * @final
 */
proto.aetherion.RiskServiceClient =
    function(hostname, credentials, options) {
  if (!options) options = {};
  options.format = 'text';
 ...
 * @final
 */
proto.aetherion.RiskServicePromiseClient =
    function(hostname, credentials, options) {
  if (!options) options = {};
  options.format = 'text';
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.aetherion.VaRRequest,
 *   !proto.aetherion.VaRResponse>}
 */
const methodDescriptor_RiskService_CalculateVaR = new grpc.web.MethodDescriptor(
  ...
  proto.aetherion.VaRResponse,
  /**
   * @param {!proto.aetherion.VaRRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.aetherion.VaRResponse.deserializeBinary
);


/**
 * @param {!proto.aetherion.VaRRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.aetherion.VaRResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.aetherion.VaRResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.aetherion.RiskServiceClient.prototype.calculateVaR =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/aetherion.RiskService/CalculateVaR',
      request,
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.aetherion.VaRResponse>}
 *     Promise that resolves to the response
 */
proto.aetherion.RiskServicePromiseClient.prototype.calculateVaR =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/aetherion.RiskService/CalculateVaR',
      request,
